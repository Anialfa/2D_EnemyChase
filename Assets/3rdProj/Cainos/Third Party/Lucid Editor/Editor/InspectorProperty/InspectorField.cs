...
namespace Cainos.LucidEditor
{
    public class InspectorField : InspectorProperty
    {
        ...
        private void DrawSerializeReferenceField(Rect position, InspectorField property)
        {
            ...
            buttonLabel.text = (property.serializedProperty.managedReferenceFullTypename == null ? "Null" : property.serializedProperty.managedReferenceFullTypename.GetType().Name) +
